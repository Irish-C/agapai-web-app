...
export default function RealTimeAlertModal({ incident, onDismiss }) {
    ...
    return (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-20 backdrop-blur-sm">
            ...
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl p-6 transform transition-all border-2 border-red-600" style={{boxShadow: '0 0 30px rgba(220, 38, 38, 0.4), 0 0 60px rgba(220, 38, 38, 0.2)'}}>
                ...
                <div className="mt-6 space-y-3 bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <p className="mt-3 text-sm text-red-600 font-semibold bg-red-50 p-3 rounded border-l-4 border-red-600">
